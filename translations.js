...
const translations = {
  de: {
    ...
    'settings-api-title': 'REST API-Zugriff',
    'settings-api-token-label': 'Persönlicher API-Token',
    'settings-api-placeholder-token': 'Kein aktiver API-Token. Generiere einen Token...',
    'settings-api-btn-generate': 'Token generieren',
    'settings-api-btn-revoke': 'Token löschen',
    'settings-api-endpoint-label': 'API-Endpunkt (Punches):',
    'settings-api-info-text': 'Verwende diesen Token im Authorization-Header (Bearer <Token>) oder als Query-Parameter (?token=<Token>). Der Endpunkt unterstützt optionale Filter from=YYYY-MM-DD und to=YYYY-MM-DD.',
    ...
    'settings-compliance-title': 'Compliance & Pausen-Regeln',
    'settings-break-profile-label': 'Pausen-Abzugs-Profil',
    'break-profile-austria': 'Österreich (30 Min. ab 6 Std. Arbeit)',
    'break-profile-germany': 'Deutschland (30 Min. ab 6 Std. / 45 Min. ab 9 Std.)',
    'break-profile-custom': 'Benutzerdefinierte Regeln',
    'break-profile-disabled': 'Deaktiviert (Kein autom. Abzug)',
    'settings-break-custom-rules-title': 'Benutzerdefinierte Pausenregeln',
    'settings-break-custom-rule-threshold': 'Ab Arbeitszeit (Std.)',
    'settings-break-custom-rule-deduction': 'Abzug Pause (Min.)',
    ...
    'alert-api-token-copied': 'API-Token in Zwischenablage kopiert!',
    'alert-api-token-revoke-confirm': 'Möchtest du das API-Token wirklich widerrufen? Externe Abfragen werden dadurch blockiert.',
  ...
  en: {
    ...
    'settings-api-title': 'REST API Access',
    'settings-api-token-label': 'Personal API Token',
    'settings-api-placeholder-token': 'No active API token. Generate a token...',
    'settings-api-btn-generate': 'Generate Token',
    'settings-api-btn-revoke': 'Revoke Token',
    'settings-api-endpoint-label': 'API Endpoint (Punches):',
    'settings-api-info-text': 'Use this token in the Authorization header (Bearer <Token>) or as a query parameter (?token=<Token>). The endpoint supports optional filters from=YYYY-MM-DD and to=YYYY-MM-DD.',
    ...
    'settings-compliance-title': 'Compliance & Break Rules',
    'settings-break-profile-label': 'Break Deduction Profile',
    'break-profile-austria': 'Austria (30 min after 6 hrs of work)',
    'break-profile-germany': 'Germany (30 min after 6 hrs / 45 min after 9 hrs)',
    'break-profile-custom': 'Custom Rules',
    'break-profile-disabled': 'Disabled (No auto deduction)',
    'settings-break-custom-rules-title': 'Custom Break Rules',
    'settings-break-custom-rule-threshold': 'After Work Hours',
    'settings-break-custom-rule-deduction': 'Break Deduction (Min)',
    ...
    'alert-api-token-copied': 'API token copied to clipboard!',
    'alert-api-token-revoke-confirm': 'Do you really want to revoke the API token? This will block future external queries.',
