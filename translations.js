...
const translations = {
  de: {
    ...
    // Team management
    'nav-team': 'Team',
    'team-title': 'Team-Verwaltung & Übersicht',
    'team-th-employee': 'Mitarbeiter',
    'team-th-status': 'Status',
    'team-th-week-total': 'Wochenstunden (Ist)',
    'team-th-actions': 'Aktionen',
    'team-status-working': 'Arbeitet seit {time}',
    'team-status-break': 'Pause seit {time}',
    'team-status-stopped': 'Nicht eingestempelt',
    'team-btn-view-history': 'Zeiten',
    'team-btn-view-reports': 'Berichte',
    'team-btn-add-user': '+ Mitarbeiter hinzufügen',
    'settings-label-role': 'Benutzer-Rolle',
    'settings-role-user': 'Mitarbeiter (Standard)',
    'settings-role-admin': 'Administrator (Manager)',
    'settings-admin-demote-error': 'Fehler: Es muss mindestens ein Administrator im System verbleiben.',
    'settings-label-active': 'Benutzer-Status',
    'settings-active-enabled': 'Aktiv (Anmeldung erlaubt)',
    'settings-active-disabled': 'Inaktiv (Gesperrt)',
    'settings-status-inactive-error': 'Fehler: Dieses Profil ist inaktiv und kann sich nicht anmelden.',
    'admin-viewing-label': 'Betrachtetes Profil:',
    ...
    'settings-label-devicemode': 'Geräte-Modus',
    'settings-devicemode-shared': 'Shared Kiosk (alle Profile anzeigen)',
    'settings-devicemode-personal': 'Personal Phone (Sperrbildschirm überspringen)',
    'settings-sync-mode-label': 'Verbindungs-Modus:',
    'settings-sync-company-label': 'Unternehmen:',
    'settings-sync-btn-invite': 'Einladungscode generieren',
    'settings-sync-btn-join': 'Unternehmen beitreten (Einladungscode)',
    'join-title': 'Unternehmen beitreten',
    'join-desc': 'Gib den Einladungscode deines Unternehmens ein, um dein Profil zu verknüpfen.',
    'join-label-code': 'Einladungscode',
    'join-btn-cancel': 'Abbrechen',
    'join-btn-submit': 'Beitreten',
    'server-label-mode': 'Verbindungs-Modus',
    'server-mode-standalone': 'Stand-Alone / Privat (Kein Unternehmen)',
    'server-mode-kiosk': 'Kiosk-Modus (Mit Unternehmen verbinden)',
    'server-mode-create': 'Neues Unternehmen gründen',
    'server-label-company-name': 'Unternehmens-Name',
    'server-label-company-code': 'Unternehmens-Code',
    'server-label-company-key': 'Unternehmens-Schlüssel / Passwort',
    'alert-company-created': 'Unternehmen erfolgreich erstellt! Code: {code}',
    'alert-company-joined': 'Erfolgreich dem Unternehmen beigetreten!',
    'alert-invite-generated': 'Einladungscode generiert: {code} (Gültig für 48 Stunden)',
  },
  en: {
    // Lock Screen
    ...
    // Team management
    'nav-team': 'Team',
    'team-title': 'Team Management & Overview',
    'team-th-employee': 'Employee',
    'team-th-status': 'Status',
    'team-th-week-total': 'Weekly Hours (Actual)',
    'team-th-actions': 'Actions',
    'team-status-working': 'Working since {time}',
    'team-status-break': 'On break since {time}',
    'team-status-stopped': 'Not clocked in',
    'team-btn-view-history': 'Times',
    'team-btn-view-reports': 'Reports',
    'team-btn-add-user': '+ Add Employee',
    'settings-label-role': 'User Role',
    'settings-role-user': 'Employee (Default)',
    'settings-role-admin': 'Administrator (Manager)',
    'settings-admin-demote-error': 'Error: At least one administrator must remain in the system.',
    'settings-label-active': 'User Status',
    'settings-active-enabled': 'Active (Login allowed)',
    'settings-active-disabled': 'Inactive (Blocked)',
    'settings-status-inactive-error': 'Error: This profile is inactive and cannot log in.',
    'admin-viewing-label': 'Viewing Profile:',
    ...
    'settings-label-devicemode': 'Device Mode',
    'settings-devicemode-shared': 'Shared Kiosk (show all profiles)',
    'settings-devicemode-personal': 'Personal Phone (skip lock screen)',
    'settings-sync-mode-label': 'Connection Mode:',
    'settings-sync-company-label': 'Company:',
    'settings-sync-btn-invite': 'Generate Invite Code',
    'settings-sync-btn-join': 'Join Company (Invite Code)',
    'join-title': 'Join Company',
    'join-desc': 'Enter your company\'s invite code to link your profile.',
    'join-label-code': 'Invite Code',
    'join-btn-cancel': 'Cancel',
    'join-btn-submit': 'Join',
    'server-label-mode': 'Connection Mode',
    'server-mode-standalone': 'Stand-Alone / Private (No Company)',
    'server-mode-kiosk': 'Kiosk Mode (Connect to Company)',
    'server-mode-create': 'Register New Company',
    'server-label-company-name': 'Company Name',
    'server-label-company-code': 'Company Code',
    'server-label-company-key': 'Company Secret Key / Password',
    'alert-company-created': 'Company successfully created! Code: {code}',
    'alert-company-joined': 'Successfully joined the company!',
    'alert-invite-generated': 'Invite code generated: {code} (Valid for 48 hours)',
  }
};
